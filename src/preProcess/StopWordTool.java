...
/**
 * The list of stop words contains words for search engines. We only removed
 * numbers.
 * 
 * @author Salim
 * 
...
public class StopWordTool {
	public static final String[] STOP_WORDS = new String[] { "a", "about",
			...
			"the" };
	private static final HashMap<String, Boolean> map = initMap();

	public StopWordTool() {
	}

	private static HashMap<String, Boolean> initMap() {
